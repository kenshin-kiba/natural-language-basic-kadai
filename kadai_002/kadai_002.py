...
Original file is located at
    https://colab.research.google.com/drive/1VRuG4frVcyYnJCEXFE8Up47_2jTsMNDg
"""
...
split_text_list = ['近頃', 'は', '大分方々', 'の', '雑誌', 'から', '談話', 'を', 'しろしろ', 'と', '責められ', 'て', '、' , '頭', 'が', 'がらん胴', 'に', 'なった', 'から' , '、' , '当分', '品切れ', 'の', '看板', 'でも', '懸けたい', 'くらい', 'に', '思って', 'います', '。' ]
